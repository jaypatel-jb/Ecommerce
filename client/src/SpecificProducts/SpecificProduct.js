...
function SpecificProduct() {
  ...
  let convertJasonString = interestedproduct.InterestedProduclist.map((elm) =>
    JSON.stringify(elm)
  );
  ...
  function handleAddtocart() {
    if (
      CartProductlist.CartProduc.map((elm) => elm.id).includes(cartQuntity.id)
    ) {
      setTimeout(() => {
  ...
  return (
    <>
      <Box width="100%" height="56px">
        {Cartloder ? (
          <Alert
            icon={<CheckCircle sx={{ color: "Background" }} />}
        ...
        <Grid item xl={7} sm={12}>
          <Box height="100%">
            ...
            <Box display="flex" alignItems="center">
              <Typography my={2} component="span" variant="h3">
                {price}₹
              </Typography>
              <Typography
                sx={{ textDecoration: "line-through", color: "#878787" }}
                my={2}
                mx={3}
                component="span"
                variant="h5"
            ...
            <Typography variant="p1" my={1} component="p">
              {" "}
              Name: {title}
            </Typography>
            <Typography variant="p1" my={1} component="p">
            ...
            >
              ...
              elit. Cum dignissimos odio inventore. Odit esse corrupti molestias
              totam ut rerum consequuntur at suscipit nostrum facilis iste,
              ducimus nisi dolor delectus ea nihil inventore, quos recusandae
              assumenda iusto dolores. Excepturi, ea soluta!{" "}
            </Typography>
          </Box>
        </Grid>

        <Box width="100%" height="100%">
          <Typography mx={5} variant="h5">
            {" "}
            ...
            >
              {interastedProduct.map((ele) => {
                return (
                  ...
                  >
                    <img
                      onClick={() => handleinterastedProducts(ele.id)}
                      style={{
                        width: "60%",
                        height: "60%",
                        borderRadius: "5px",
